                ...
                <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                  <div>
                    <p className="text-sm text-gray-700">
                      ...
                      to <span className="font-medium">{index * 10}</span> of{" "}
                  ...
                  <div>
                    ...
                    >
                      <div
                        onClick={(e) =>
                          handlepage(index > 1 ? index - 1 : index)
                        }
                          ...
                          for (let i = 1; i <= totalPages; i++) {
                            elements.push(
                              <a
                                ...
                                className={`relative z-10 inline-flex border border-solid border-gray-100 border-l-2 items-center ${
                                  index === i
                      ...
                      <div
                        onClick={(e) =>
                          handlepage(index < totalPages ? index + 1 : index)
                        }
